...
os.system('sudo docker build -t cic -f ./dockerfile-cic .')
...
os.system('git fetch')
os.system('git reset --hard origin')
os.system('sudo docker build -t galaxy -f ./dockerfile-galaxy .')
...
os.system('git fetch')
os.system('git reset --hard origin')
os.system('sudo docker build -t utexas -f ./dockerfile-utexas .')
